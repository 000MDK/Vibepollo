...
// src/platform/common.h pulls in boost_process_shim.h, which includes
// winsock2.h. That must happen before any header that drags in <windows.h>
// (Audioclient.h/mmdeviceapi.h do), or winsock2.h emits:
