...
Experimental AV1 tile-count override for the native `amdvce_experimental` encoder only. Set this in `sunshine.conf`.
...
Invalid values fall back to `0`. This does not affect H.264, HEVC or `amdvce_ffmpeg`.
